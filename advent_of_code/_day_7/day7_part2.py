...
class Content():
    ...
    def available_space(self):
        current_space = identfiyDirectSize('/', self.terminal_contents)
        available = self.total_space - current_space
        return available
